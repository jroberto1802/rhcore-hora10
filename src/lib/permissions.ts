...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    permissions: [
      { codigo: "menu.clima", label: "Acessar módulo Clima Organizacional" },
      { codigo: "clima.campanhas.visualizar", label: "Visualizar campanhas" },
      { codigo: "clima.campanhas.criar", label: "Criar campanhas" },
      { codigo: "clima.campanhas.editar", label: "Editar campanhas" },
      { codigo: "clima.campanhas.encerrar", label: "Encerrar campanhas" },
      { codigo: "clima.participantes.gerenciar", label: "Gerenciar participantes e tokens" },
      { codigo: "clima.resultados.visualizar", label: "Visualizar resultados e dashboard" },
      { codigo: "clima.diagnostico.visualizar", label: "Acessar diagnóstico e insights" },
      { codigo: "clima.planos.gerenciar", label: "Gerenciar planos de ação" },
      { codigo: "clima.configuracoes.editar", label: "Editar pilares e perguntas" },
    ],
  },
  {
    label: "Ciclo de Gente",
    permissions: [
      { codigo: "menu.ciclo_gente", label: "Acessar módulo Ciclo de Gente" },
      { codigo: "ciclo.visualizar", label: "Visualizar ciclos" },
      { codigo: "ciclo.criar", label: "Criar ciclos" },
      { codigo: "ciclo.editar", label: "Editar ciclos" },
      { codigo: "ciclo.encerrar", label: "Encerrar ciclos" },
      { codigo: "ciclo.participantes.gerenciar", label: "Gerenciar participantes" },
      { codigo: "ciclo.avaliacao.preencher", label: "Preencher avaliação de desempenho" },
      { codigo: "ciclo.reuniao.preencher", label: "Preencher reunião de gente" },
      { codigo: "ciclo.feedback.preencher", label: "Preencher registro de feedback" },
      { codigo: "ciclo.pdi.preencher", label: "Preencher PDI / Plano de Reversão" },
      { codigo: "ciclo.follow.preencher", label: "Preencher follow" },
    ],
  },
  {
...
export const MENU_PERMISSION_MAP: Record<string, string[]> = {
  ...
  "/clima/pesquisas": ["menu.clima"],
  "/ciclo-gente": ["menu.ciclo_gente"],
